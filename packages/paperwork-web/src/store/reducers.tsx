...
import { mapping as TemplatePreviewPageActionMapping, defaultState as templatePreview } from '../pages/template/preview/state/reducers';
...
const mapping = {
  ...
  ...TemplatePreviewPageActionMapping,
};
